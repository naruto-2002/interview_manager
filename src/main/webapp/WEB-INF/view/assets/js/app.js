...
var App = (function () {
  ...
  var e,
    ...
    k = {};
  function y(e) {
    var t = $("<div>", { class: e }).appendTo("body"),
  ...
  function A() {
    ...
    n.length > 0 &&
      ($(".be-toggle-right-sidebar").on("click", function (t) {
  ...
  return {
    ...
    init: function (E) {
      ...
      v.enableLeftSidebar
        ? (function () {
            ...
            function b(e, i) {
              ...
              !$.isSm() && m() && (c || l)
                ? (a.removeClass("open"), e.removeClass("visible"), r.removeClass("open").removeAttr("style"))
                : e.slideUp({
                    duration: s,
                    complete: function () {
            ...
            t.hasClass(v.collapsibleSidebarClass) &&
              ((a = void 0 !== n ? n : $(".sidebar-elements > li", o)),
              $.each(a, function () {
              ...
              $(".be-toggle-left-sidebar").on("click", function () {
                t.hasClass(v.collapsibleSidebarCollapsedClass)
                  ? (t.removeClass(v.collapsibleSidebarCollapsedClass),
              ...
              (function () {
                for (var e = $(".sidebar-elements > li > a", o), i = 0; i <= e.length; i++) {
                  var n = e[i],
                    a = $("> span", n).text();
                  $(n).attr({ "data-toggle": "tooltip", "data-placement": "right", title: a }), $(n).tooltip({ trigger: "manual" });
                }
              ...
              i.find(".container-fluid > .navbar-collapse").length &&
                o.length &&
                (t.addClass(v.offCanvasLeftSidebarClass).addClass(v.offCanvasLeftSidebarMobileClass),
              ...
              t.hasClass("be-fixed-sidebar") &&
                (($.isSm() && !t.hasClass(v.offCanvasLeftSidebarClass)) || (void 0 !== d && d && d.nodeName) || (d = x(h)),
                $(window).resize(function () {
                  P(
                    function () {
              ...
              t.hasClass(v.offCanvasLeftSidebarClass) &&
      ...
      v.scrollTop &&
        ((B = $('<div class="be-scroll-top"></div>')).appendTo("body"),
      ...
      "function" == typeof Swal && t.hasClass("be-boxed-layout")) &&
        new MutationObserver(function (e, t) {
          e.forEach(function (e) {
            "attributes" == e.type &&
              "style" == e.attributeName &&
              (document.body.className.indexOf("swal2-shown") > 0 ? i.css({ marginLeft: "calc(-" + document.body.style.paddingRight + " / 2)" }) : i.css({ marginLeft: "0" }));
          });
  ...
  if (
    ...
    deviceIsAndroid && (e.addEventListener("mouseover", this.onMouse, !0), e.addEventListener("mousedown", this.onMouse, !0), e.addEventListener("mouseup", this.onMouse, !0)),
      ...
      Event.prototype.stopImmediatePropagation ||
        ((e.removeEventListener = function (t, i, o) {
...
(FastClick.prototype.needsClick = function (e) {
  ...
  (FastClick.prototype.onTouchEnd = function (e) {
    ...
    if (
      ...
      return e.timeStamp - i > 100 || (deviceIsIOS && window.top !== window && "input" === o)
        ? ((this.targetElement = null), !1)
        : (this.focus(r), this.sendClick(r, e), (deviceIsIOS && "select" === o) || ((this.targetElement = null), e.preventDefault()), !1);
  ...
  (FastClick.prototype.onClick = function (e) {
    ...
    return this.trackingClick
      ...
      : ("submit" === e.target.type && 0 === e.detail) || ((t = this.onMouse(e)) || (this.targetElement = null), t);
  }),
  ...
  (function (e) {
            ...
            ((_ = new (function (t, T) {
                ...
                if (!(!0 === Ce.data(A + "_intouch") || e(t.target).closest(T.excludedElements, Ce).length > 0)) {
                  ...
                  if (!r.pointerType || "mouse" != r.pointerType || 0 != T.fallbackToMouseEvents) {
                    ...
                    return (
                      ...
                      V(),
                      Z(0, c),
                      !s || Se === T.fingers || T.fingers === b || Y()
                        ? ((Ae = ae()), 2 == Se && (Z(1, s[1]), (me = be = oe(xe[0].start, xe[1].start))), (T.swipeStatus || T.pinchStatus) && (l = D(r, $e)))
                        : (l = !1),
                      !1 === l
                        ? (D(r, ($e = C)), l)
                        : (T.hold &&
              ...
              function M(t) {
                var d,
                  ...
                  w,
                  $,
                  S = t.originalEvent ? t.originalEvent : t;
                if ($e !== y && $e !== C && !Q()) {
                  var x,
                    A = S.touches,
                    _ = A ? A[0] : S,
                  ...
                  if (
                    ...
                    ($e = k),
                    2 == Se &&
                      (0 == me ? (Z(1, A[1]), (me = be = oe(xe[0].start, xe[1].start))) : (K(A[1]), (be = oe(xe[0].end, xe[1].end)), xe[0].end, xe[1].end, (ke = ve < 1 ? l : r)),
                    ...
                    if (
                      ...
                      (ge = ie()),
                      (v = pe),
                      (f = he) != s && ((v = Math.max(v, ee(f))), (ye[f].distance = v)),
                      (x = D(S, $e)),
                      !T.triggerOnTouchEnd || T.triggerOnTouchLeave)
                    ) {
                      var E = !0;
                      if (T.triggerOnTouchLeave) {
                        var P = { left: (h = (p = e((p = this))).offset()).left, right: h.left + p.outerWidth(), top: h.top, bottom: h.top + p.outerHeight() };
              ...
              function E(e) {
                ...
                return (
                  ...
                  O() || !R()
                    ? D(i, ($e = C))
                    : T.triggerOnTouchEnd || (!1 === T.triggerOnTouchEnd && $e === k)
                    ? (!1 !== T.preventDefaultEvents && !1 !== e.cancelable && e.preventDefault(), D(i, ($e = y)))
                    : !T.triggerOnTouchEnd && X()
                    ? I(i, ($e = y), p)
                    : $e === k && D(i, ($e = C)),
                  J(!1),
                  null
              ...
              function D(e, t) {
                ...
                return (
                  ...
                  G() && j() && !1 !== i
                    ? (i = I(e, t, h))
                    : ge > T.longTapThreshold && pe < v && T.longTap && !1 !== i
                    ? (i = I(e, t, f))
                    : !((1 !== Se && $) || !(isNaN(pe) || pe < T.threshold) || !X()) && !1 !== i && (i = I(e, t, p)),
                  t === C && P(),
                  t === y && ((o && o.length) || P()),
                  i
                );
              ...
              function I(t, s, c) {
                var g;
                if (c == d) {
                  if ((Ce.trigger("swipeStatus", [s, he || null, pe || 0, ge || 0, Se, xe, fe]), T.swipeStatus && !1 === (g = T.swipeStatus.call(Ce, t, s, he || null, pe || 0, ge || 0, Se, xe, fe))))
                    return !1;
                  if (s == y && z()) {
                ...
                if (c == u) {
                  if ((Ce.trigger("pinchStatus", [s, ke || null, we || 0, ge || 0, Se, ve, xe]), T.pinchStatus && !1 === (g = T.pinchStatus.call(Ce, t, s, ke || null, we || 0, ge || 0, Se, ve, xe))))
                    return !1;
                  if (s == y && H())
                    switch (ke) {
                      case r:
                  ...
                  c == p
                    ? (s !== C && s !== y) ||
                      ...
                      j() && !G()
                        ...
                        : ((Ee = null), Ce.trigger("tap", [t.target]), T.tap && (g = T.tap.call(Ce, t, t.target))))
                    : c == h
                    ? (s !== C && s !== y) || (clearTimeout(Pe), clearTimeout(Be), (Ee = null), Ce.trigger("doubletap", [t.target]), T.doubleTap && (g = T.doubleTap.call(Ce, t, t.target)))
                    : c == f && ((s !== C && s !== y) || (clearTimeout(Pe), (Ee = null), Ce.trigger("longtap", [t.target]), T.longTap && (g = T.longTap.call(Ce, t, t.target)))),
                  g
                );
              }
              function R() {
    ...
    (e.fn.swipe = function (i) {
      ...
      (e.fn.swipe.phases = { PHASE_START: w, PHASE_MOVE: k, PHASE_END: y, PHASE_CANCEL: C }),
      (e.fn.swipe.directions = { LEFT: i, RIGHT: o, UP: n, DOWN: a, IN: r, OUT: l }),
      (e.fn.swipe.pageScroll = { NONE: s, HORIZONTAL: g, VERTICAL: m, AUTO: c }),
  ...
  (function (e) {
    function t(i, o) {
      ...
      var n,
        ...
        g =
          ...
          "string" == typeof (n = i) &&
            (n = (function (e) {
              ...
              return (t = H.rgb.exec(e))
                ...
                : (t = H.hex8.exec(e))
                ? { r: C(t[1]), g: C(t[2]), b: C(t[3]), a: A(t[4]), format: i ? "name" : "hex8" }
                : (t = H.hex6.exec(e))
                ? { r: C(t[1]), g: C(t[2]), b: C(t[3]), format: i ? "name" : "hex" }
                : (t = H.hex4.exec(e))
                ? { r: C(t[1] + "" + t[1]), g: C(t[2] + "" + t[2]), b: C(t[3] + "" + t[3]), a: A(t[4] + "" + t[4]), format: i ? "name" : "hex8" }
                : !!(t = H.hex3.exec(e)) && { r: C(t[1] + "" + t[1]), g: C(t[2] + "" + t[2]), b: C(t[3] + "" + t[3]), format: i ? "name" : "hex" };
            })(n)),
          "object" == typeof n &&
            (T(n.r) && T(n.g) && T(n.b)
              ? ((p = n.r), (h = n.g), (f = n.b), (a = { r: 255 * k(p, 255), g: 255 * k(h, 255), b: 255 * k(f, 255) }), (d = !0), (u = "%" === String(n.r).substr(-1) ? "prgb" : "rgb"))
              : T(n.h) && T(n.s) && T(n.v)
              ? ((l = S(n.s)),
                (s = S(n.v)),
                (a = (function (t, i, o) {
              ...
              : T(n.h) &&
                ...
                (a = (function (e, t, i) {
                  ...
                  var n, a, r;
                  if (((e = k(e, 360)), (t = k(t, 100)), (i = k(i, 100)), 0 === t)) n = a = r = i;
                  else {
                    var l = 0.5 > i ? i * (1 + t) : i + t - i * t,
                      s = 2 * i - l;
          ...
          (r = w(r)),
          { ok: d, format: n.format || u, r: B(255, L(a.r, 0)), g: B(255, L(a.g, 0)), b: B(255, L(a.b, 0)), a: r });
    ...
    function i(e, t, i) {
      ...
      if (a == r) o = n = 0;
        ...
        var s = a - r;
        switch (((n = l > 0.5 ? s / (2 - a - r) : s / (a + r)), a)) {
          case e:
            o = (t - i) / s + (i > t ? 6 : 0);
            break;
          case t:
    ...
    function g(e) {
      var i = t(e).toHsl(),
        o = i.h;
      return [t(e), t({ h: (o + 90) % 360, s: i.s, l: i.l }), t({ h: (o + 180) % 360, s: i.s, l: i.l }), t({ h: (o + 270) % 360, s: i.s, l: i.l })];
    }
    function m(e) {
      var i = t(e).toHsl(),
        o = i.h;
    ...
    function v(e, i) {
      i = i || 6;
      for (var o = t(e).toHsv(), n = o.h, a = o.s, r = o.v, l = [], s = 1 / i; i--; ) l.push(t({ h: n, s: a, v: r })), (r = (r + s) % 1);
      return l;
    }
    function w(e) {
    ...
    function k(t, i) {
      ...
      var n,
        a = "string" == typeof (n = t) && -1 != n.indexOf("%");
    ...
    (t.prototype = {
      ...
      getLuminance: function () {
        ...
        return (
          ...
          (i = n.g / 255),
          (o = n.b / 255),
          0.2126 * (0.03928 >= t ? t / 12.92 : e.pow((t + 0.055) / 1.055, 2.4)) +
            0.7152 * (0.03928 >= i ? i / 12.92 : e.pow((i + 0.055) / 1.055, 2.4)) +
            0.0722 * (0.03928 >= o ? o / 12.92 : e.pow((o + 0.055) / 1.055, 2.4))
        );
      },
      setAlpha: function (e) {
      ...
      toHex8: function (e) {
        return (
          ...
          a && r[0].charAt(0) == r[0].charAt(1) && r[1].charAt(0) == r[1].charAt(1) && r[2].charAt(0) == r[2].charAt(1) && r[3].charAt(0) == r[3].charAt(1)
      ...
      toPercentageRgb: function () {
        return { r: P(100 * k(this._r, 255)) + "%", g: P(100 * k(this._g, 255)) + "%", b: P(100 * k(this._b, 255)) + "%", a: this._a };
      },
      toPercentageRgbString: function () {
        return 1 == this._a
          ? "rgb(" + P(100 * k(this._r, 255)) + "%, " + P(100 * k(this._g, 255)) + "%, " + P(100 * k(this._b, 255)) + "%)"
          : "rgba(" + P(100 * k(this._r, 255)) + "%, " + P(100 * k(this._g, 255)) + "%, " + P(100 * k(this._b, 255)) + "%, " + this._roundA + ")";
      },
      toName: function () {
      ...
      toString: function (e) {
        ...
        return !t && o && ("hex" === e || "hex6" === e || "hex3" === e || "hex4" === e || "hex8" === e || "name" === e)
          ? "name" === e && 0 === this._a
            ? this.toName()
            : this.toRgbString()
      ...
      (t.mix = function (e, i, o) {
        ...
        var n = t(e).toRgb(),
          a = t(i).toRgb(),
          r = o / 100;
        return t({ r: (a.r - n.r) * r + n.r, g: (a.g - n.g) * r + n.g, b: (a.b - n.b) * r + n.b, a: (a.a - n.a) * r + n.a });
      }),
      (t.readability = function (i, o) {
        var n = t(i),
          a = t(o);
        return (e.max(n.getLuminance(), a.getLuminance()) + 0.05) / (e.min(n.getLuminance(), a.getLuminance()) + 0.05);
      }),
      (t.isReadable = function (e, i, o) {
        ...
        switch (
          ((a = !1),
          "AA" !== (l = ((r = (r = o) || { level: "AA", size: "small" }).level || "AA").toUpperCase()) && "AAA" !== l && (l = "AA"),
          "small" !== (s = (r.size || "small").toLowerCase()) && "large" !== s && (s = "small"),
          (n = { level: l, size: s }).level + n.size)
        ) {
          case "AAsmall":
          case "AAAlarge":
            a = c >= 4.5;
      ...
      (t.mostReadable = function (e, i, o) {
        ...
        return t.isReadable(e, s, { level: r, size: l }) || !a ? s : ((o.includeFallbackColors = !1), t.mostReadable(e, ["#fff", "#000"], o));
      });
    var D,
      I,
      R,
      ...
      (App.ChartJs = function () {
        ...
        (e = tinycolor(App.color.primary)),
          ...
          (o = {
            ...
            datasets: [
              { label: "My First dataset", borderColor: e.toString(), backgroundColor: e.setAlpha(0.8).toString(), data: [A(), A(), A(), A(), A(), A(), A()] },
              { label: "My Second dataset", borderColor: t.toString(), backgroundColor: t.setAlpha(0.5).toString(), data: [A(), A(), A(), A(), A(), A(), A()] },
            ],
          }),
          new Chart(i, { type: "line", data: o }),
          ...
          (l = {
            labels: ["January", "February", "March", "April", "May", "June", "July"],
            datasets: [
              { label: "Credit", borderColor: n.toString(), backgroundColor: n.setAlpha(0.8).toString(), data: [A(), A(), A(), A(), A(), A(), A()] },
              { label: "Debit", borderColor: a.toString(), backgroundColor: a.setAlpha(0.5).toString(), data: [A(), A(), A(), A(), A(), A(), A()] },
            ],
          }),
          new Chart(r, { type: "bar", data: l, options: { elements: { rectangle: { borderWidth: 2, borderColor: "rgb(0, 255, 0)", borderSkipped: "bottom" } } } }),
          ...
          (u = {
            ...
            datasets: [
              {
                label: "First Year",
                backgroundColor: s.setAlpha(0.3).toString(),
              ...
              {
                label: "Second Year",
                backgroundColor: c.setAlpha(0.4).toString(),
          ...
          new Chart(b, {
            type: "polarArea",
            data: { datasets: [{ data: [11, 16, 7, 3, 14], backgroundColor: [g, h, f, m, p], label: "My dataset" }], labels: ["Red", "Green", "Yellow", "Grey", "Blue"] },
          }),
          (v = App.color.primary),
          ...
          new Chart(y, { type: "pie", data: { labels: ["Red", "Blue", "Yellow"], datasets: [{ data: [300, 50, 100], backgroundColor: [v, w, k], hoverBackgroundColor: [v, w, k] }] } }),
          (C = App.color.success),
          ...
          new Chart(x, { type: "doughnut", data: { labels: ["Red", "Blue", "Yellow"], datasets: [{ data: [300, 50, 100], backgroundColor: [C, $, S], hoverBackgroundColor: [C, $, S] }] } });
      }),
      App
    );
  })()),
    ...
    return (
      (App.chartsMorris = function () {
        ...
        (e = App.color.primary),
          ...
          new Morris.Line({ element: "line-chart", data: d, xkey: "period", ykeys: ["licensed", "sorned"], labels: ["Licensed", "Off the road"], lineColors: [e, t] }),
    ...
    return (
      (App.chartsSparklines = function () {
        ...
        $("#spark1").sparkline("html", {
          ...
          $("#spark3").sparkline("html", { type: "discrete", width: "85", height: "35", lineHeight: 20, lineColor: i, xwidth: 18 }),
        ...
        ($.fn.sparkline.defaults.common.lineColor = e),
          ($.fn.sparkline.defaults.common.fillColor = n.setAlpha(0.3).toString()),
          ...
          ($.fn.sparkline.defaults.bullet.rangeColors[0] = a.setAlpha(0.2).toString()),
          ($.fn.sparkline.defaults.bullet.rangeColors[1] = a.setAlpha(0.5).toString()),
          ($.fn.sparkline.defaults.bullet.rangeColors[2] = a.setAlpha(0.45).toString()),
          ...
          ($.fn.sparkline.defaults.box.boxFillColor = a.setAlpha(0.5).toString()),
          ($.fn.sparkline.defaults.box.boxLineColor = e),
          ($.fn.sparkline.defaults.box.whiskerColor = o),
          $(".compositebar").sparkline("html", { type: "bar", barColor: t }),
          $(".compositebar").sparkline([4, 1, 5, 7, 9, 9, 8, 7, 6, 6, 4, 7, 8, 4, 3, 2, 2, 5, 6, 7], { composite: !0, fillColor: !1 }),
          $(".sparklinebasic").sparkline(),
          $(".linecustom").sparkline("html", { height: "1.5em", width: "8em", lineColor: i, fillColor: r.setAlpha(0.4).toString(), minSpotColor: !1, maxSpotColor: !1, spotColor: o, spotRadius: 3 }),
          $(".sparkbar").sparkline("html", { type: "bar" }),
          $(".sparktristate").sparkline("html", { type: "tristate" }),
          $(".compositeline").sparkline("html", { fillColor: !1, changeRangeMin: 0, chartRangeMax: 10 }),
          $(".compositeline").sparkline([4, 1, 5, 7, 9, 9, 8, 7, 6, 6, 4, 7, 8, 4, 3, 2, 2, 5, 6, 7], { composite: !0, fillColor: !1, lineColor: t, changeRangeMin: 0, chartRangeMax: 10 }),
          $(".normalline").sparkline("html", { fillColor: !1, normalRangeMin: -1, normalRangeMax: 8 }),
      ...
      (App.charts = function () {
        ...
        function t(e, t) {
          $("#" + e).bind("plothover", function (e, i, o) {
            ...
            o
              ? $(".tooltip-chart")
                  .css({ top: o.pageY - t, left: o.pageX - n / 2 })
                  .fadeIn(200)
              : $(".tooltip-chart").hide();
          });
        }
        ...
        (i = tinycolor(App.color.primary).lighten(5).toString()),
          $.plot(
            ...
            {
              series: { lines: { show: !0, lineWidth: 2, fill: !0, fillColor: { colors: [{ opacity: 0.1 }, { opacity: 0.1 }] } }, points: { show: !0 }, shadowSize: 0 },
              legend: { show: !1 },
              grid: { margin: { left: 23, right: 30, top: 20, botttom: 40 }, labelMargin: 15, axisMargin: 500, hoverable: !0, clickable: !0, tickColor: "rgba(0,0,0,0.15)", borderWidth: 0 },
              tooltip: {
                show: !0,
          ...
          $.plot(
            ...
            {
              series: { bars: { order: 2, align: "center", show: !0, lineWidth: 1, barWidth: 0.35, fill: !0, fillColor: { colors: [{ opacity: 1 }, { opacity: 1 }] } }, shadowSize: 2 },
              legend: { show: !1 },
              grid: {
          ...
          $.plot(
            ...
            {
              series: { lines: { show: !0, lineWidth: 2, fill: !0, fillColor: { colors: [{ opacity: 0.35 }, { opacity: 0.35 }] } }, points: { show: !0 }, shadowSize: 0 },
              legend: { show: !1 },
              grid: { margin: { left: -8, right: -8, top: 0, bottom: 0 }, show: !1, labelMargin: 15, axisMargin: 500, hoverable: !0, clickable: !0, tickColor: "rgba(0,0,0,0.15)", borderWidth: 0 },
              tooltip: {
                show: !0,
                cssClass: "tooltip-chart",
          ...
          $.plot(
            ...
            ],
            {
              ...
              tooltip: { show: !0, cssClass: "tooltip-chart", content: "<div class='content-chart arrow-none'> <div class='label'> <div class='label-x'> %x.0% </div> </div></div>", defaultTheme: !1 },
              colors: [r, l, s, c],
              legend: { show: !1 },
            }
          ),
          ...
          $.plot(
            ...
            {
              series: { bars: { align: "center", show: !0, lineWidth: 1, barWidth: 0.6, fill: !0, fillColor: { colors: [{ opacity: 1 }, { opacity: 1 }] } }, shadowSize: 2 },
              legend: { show: !1 },
              grid: { margin: 0, show: !1, labelMargin: 10, axisMargin: 500, hoverable: !0, clickable: !0, tickColor: "rgba(0,0,0,0.15)", borderWidth: 0 },
              tooltip: {
                show: !0,
                cssClass: "tooltip-chart",
                content: "<div class='content-chart'> <span> %s </span> <div class='label'> <div class='label-x'> %x.0 </div> - <div class='label-y'> %y.0 </div> </div></div>",
          ...
          $.plot(
            ...
            {
              series: {
                lines: { show: !0, lineWidth: 0, fill: !0, fillColor: { colors: [{ opacity: 0.7 }, { opacity: 0.7 }] } },
          ...
          (function () {
            ...
            var a = 500,
              r = $.plot("#live-data", [n()], {
                series: { shadowSize: 0, lines: { show: !0, lineWidth: 1, fill: !0, fillColor: { colors: [{ opacity: 0.35 }, { opacity: 0.35 }] } } },
                grid: {
                  show: !0,
                ...
                colors: [e],
                yaxis: { show: !1, autoscaleMargin: 0.2, ticks: 5, tickDecimals: 0 },
          ...
          $.plot(
            ...
            [
              ...
              { data: m, showLabels: !0, label: "Old Visitors", labelPlacement: "below", canvasRender: !0, cColor: "#FFFFFF" },
            ],
            {
              series: {
                lines: { show: !0, lineWidth: 1.5, fill: !0, fillColor: { colors: [{ opacity: 0.5 }, { opacity: 0.5 }] } },
                fillColor: "rgba(0, 0, 0, 1)",
          ...
          $.plot(
            ...
            {
              series: {
                lines: { show: !0, lineWidth: 2, fill: !0, fillColor: { colors: [{ opacity: 0.35 }, { opacity: 0.35 }] } },
                fillColor: "rgba(0, 0, 0, 1)",
                points: { show: !0, fill: !0, fillColor: v },
                shadowSize: 0,
              },
              legend: { show: !1 },
              grid: { show: !1, margin: { left: -8, right: -8, top: 0, botttom: 0 }, labelMargin: 0, axisMargin: 0, hoverable: !0, clickable: !0, tickColor: "rgba(0, 0, 0, 0)", borderWidth: 0 },
              tooltip: {
                show: !0,
                cssClass: "tooltip-chart",
                content: "<div class='content-chart'> <span> %s </span> <div class='label'> <div class='label-x'> %x.0 </div> - <div class='label-y'> %y.0 </div> </div></div>",
  ...
  (App = (function () {
    ...
    return (
      (App.codeEditor = function () {
        ...
        var t = CodeMirror($("#console")[0], { lineNumbers: !0, theme: "monokai", value: e, mode: "text/html", tabSize: 2 });
        setTimeout(function () {
          t.refresh();
        }, 200);
      }),
      ...
      (App.dashboard = function () {
        ...
        $('[data-toggle="counter"]').each(function (e, t) {
          ...
          i.data("prefix") && (o = i.data("prefix")),
            ...
            new CountUp(i.get(0), a, r, l, s, { suffix: n, prefix: o }).start();
        }),
          $(".toggle-loading").on("click", function () {
            var e = $(this).parents(".widget, .panel");
            e.length &&
              (e.addClass("be-loading-active"),
              setTimeout(function () {
          ...
          $("#spark2").sparkline([5, 8, 7, 10, 9, 10, 8, 6, 4, 6, 8, 7, 6, 8], { type: "bar", width: "85", height: "35", barWidth: 3, barSpacing: 3, chartRangeMin: 0, barColor: t }),
          $("#spark3").sparkline([2, 3, 4, 5, 4, 3, 2, 3, 4, 5, 6, 5, 4, 3, 4, 5, 6, 5, 4, 4, 5], { type: "discrete", width: "85", height: "35", lineHeight: 20, lineColor: i, xwidth: 18 }),
          ...
          $("#main-chart").bind("plothover", function (e, t, i) {
            ...
            i
              ? $(".tooltip-chart")
                  .css({ top: i.pageY - n, left: i.pageX - o / 2 })
                  .fadeIn(200)
              : $(".tooltip-chart").hide();
          }),
          $('[data-color="main-chart-color1"]').css({ "background-color": a }),
          $('[data-color="main-chart-color2"]').css({ "background-color": r }),
          $('[data-color="main-chart-color3"]').css({ "background-color": l }),
          (s = App.color.success),
          (c = App.color.warning),
          (d = App.color.primary),
          $.plot(
            ...
            { series: { pie: { radius: 0.75, innerRadius: 0.58, show: !0, highlight: { opacity: 0.1 }, label: { show: !1 } } }, grid: { hoverable: !0 }, legend: { show: !1 }, colors: [s, c, d] }
          ),
          $('[data-color="top-sales-color1"]').css({ "background-color": s }),
  ...
  (App = (function () {
    ...
    return (
      (App.formElements = function () {
        $(".datetimepicker").datetimepicker({ autoclose: !0, componentIcon: ".mdi.mdi-calendar", navIcons: { rightIcon: "mdi mdi-chevron-right", leftIcon: "mdi mdi-chevron-left" } }),
          $(".select2").select2({ width: "100%", placeholder: "Select a state" }),
          $(".tags").select2({ tags: !0, width: "100%" }),
          $(".bslider").bootstrapSlider(),
          $(".inputfile").each(function () {
            ...
            e.on("change", function (e) {
              ...
              this.files && this.files.length > 1
                ? (o = (this.getAttribute("data-multiple-caption") || "").replace("{count}", this.files.length))
                : e.target.value && (o = e.target.value.split("\\").pop()),
    ...
    return (
      (App.formMultiselect = function () {
        $("#my-select").multiSelect(),
          ...
          $("#custom-headers").multiSelect({ selectableHeader: "<div class='custom-header'>Selectable items</div>", selectionHeader: "<div class='custom-header'>Selection items</div>" }),
  ...
  (App = (function () {
    ...
    return (
      (App.mapsGoogle = function () {
        var e = { zoom: 14, center: new google.maps.LatLng(-33.877827, 151.188598), mapTypeId: google.maps.MapTypeId.ROADMAP };
        ...
        e = { zoom: 14, center: new google.maps.LatLng(-33.877827, 151.188598), mapTypeId: google.maps.MapTypeId.TERRAIN };
    ...
    return (
      (App.mapsVector = function () {
        var e = App.color.primary,
          ...
          l = App.color.danger;
        $("#usa-map").vectorMap({ map: "us_merc_en", backgroundColor: "transparent", regionStyle: { initial: { fill: e }, hover: { "fill-opacity": 0.8 } } }),
          $("#france-map").vectorMap({ map: "fr_merc_en", backgroundColor: "transparent", regionStyle: { initial: { fill: t }, hover: { "fill-opacity": 0.8 } } }),
          $("#uk-map").vectorMap({ map: "uk_mill_en", backgroundColor: "transparent", regionStyle: { initial: { fill: i }, hover: { "fill-opacity": 0.8 } } }),
          $("#chicago-map").vectorMap({ map: "us-il-chicago_mill_en", backgroundColor: "transparent", regionStyle: { initial: { fill: o }, hover: { "fill-opacity": 0.8 } } }),
          $("#australia-map").vectorMap({ map: "au_mill_en", backgroundColor: "transparent", regionStyle: { initial: { fill: n }, hover: { "fill-opacity": 0.8 } } }),
          $("#india-map").vectorMap({ map: "in_mill_en", backgroundColor: "transparent", regionStyle: { initial: { fill: a }, hover: { "fill-opacity": 0.8 } } }),
          $("#vector-map").vectorMap({
            map: "map",
            backgroundColor: "transparent",
            regionStyle: { initial: { fill: r, "fill-opacity": 0.8, stroke: "none", "stroke-width": 0, "stroke-opacity": 1 }, hover: { "fill-opacity": 0.8 } },
          ...
          $("#canada-map").vectorMap({ map: "ca_lcc_en", backgroundColor: "transparent", regionStyle: { initial: { fill: l }, hover: { "fill-opacity": 0.8 } } });
      }),
      App
    );
  })()),
        ...
        $(".be-sub-header .nav-link, .be-sub-header .dropdown-item", e).on("click", function (e) {
          ...
          $.isSm()
            ? (a.length &&
                ...
                e.preventDefault()),
              e.stopPropagation())
            : o.parent().hasClass("navbar-nav") && a.length && (n.removeClass("open"), o.addClass("open"), e.preventDefault());
        }),
          $(window).resize(function () {
            o(
              function () {
    ...
    return (
      (App.pageCalendar = function () {
        $("#external-events .fc-event").each(function () {
          $(this).data("event", { title: $.trim($(this).text()), stick: !0 }), $(this).draggable({ zIndex: 999, revert: !0, revertDuration: 0 });
        }),
          $("#calendar").fullCalendar({
            header: { left: "title", center: "", right: "month,agendaWeek,agendaDay, today, prev,next" },
            ...
            events: [
              ...
              { id: 999, title: "Repeating Event", start: "2016-06-16T16:00:00" },
              { title: "Conference", start: "2016-06-11", end: "2016-06-13" },
              { title: "Meeting", start: "2016-06-12T10:30:00", end: "2016-06-12T12:30:00" },
              ...
              { title: "Click for Google", url: "http://google.com/", start: "2016-06-28" },
            ],
          });
      }),
      App
      ...
      (App.pageProfile = function () {
        ...
        (t = App.color.primary),
          ...
          $.plot(
            ...
            {
              series: { bars: { order: 2, align: "center", show: !0, barWidth: 0.3, lineWidth: 0.7, fill: !0, fillColor: { colors: [{ opacity: 1 }, { opacity: 1 }] } }, shadowSize: 2 },
              legend: { show: !1 },
              grid: { margin: 0, show: !1, labelMargin: 10, axisMargin: 500, hoverable: !0, clickable: !0, tickColor: "rgba(0,0,0,0.15)", borderWidth: 0 },
              tooltip: {
                show: !0,
          ...
          $("#bar-chart1").bind("plothover", function (t, i, o) {
            ...
            o
              ? $(".tooltip-chart")
                  .css({ top: o.pageY - e, left: o.pageX - n / 2 })
                  .fadeIn(200)
              : $(".tooltip-chart").hide();
          });
      }),
      ...
      (App.tableFilters = function () {
        $(".select2").select2({ width: "100%" }),
          ...
          $.fn.dataTable.ext.search.push(function (e, t, i, o, n) {
            ...
            return (
              parseInt(r[1]) >= parseInt(a[0]) &&
              parseInt(r[1]) <= parseInt(a[1]) &&
              (l == s || "All" == l) &&
              u >= c &&
              u <= d &&
              ((0 == p && 0 == h && 0 == f && 0 == g) || (1 == p && "to-do" == m[1]) || (1 == h && "in-progress" == m[1]) || (1 == f && "in-review" == m[1]) || (1 == g && "done" == m[1]))
            );
          });
        var e = $("#table1").DataTable({ pageLength: 5, dom: "<'row be-datatable-body'<'col-sm-12'tr>><'row be-datatable-footer'<'col-sm-5'i><'col-sm-7'p>>" });
        $("#milestone_slider")
          .slider()
          .on("slide", function (t) {
            var i = t.value[0],
      ...
      (App.dataTables = function () {
        ($.fn.DataTable.ext.pager.numbers_length = 4),
          $.extend(!0, $.fn.dataTable.defaults, {
            dom: 
            "<'row be-datatable-header'<'col-sm-6'l><'col-sm-6'f>><'row be-datatable-body'<'col-sm-12'tr>><'row be-datatable-footer'<'col-sm-5'i><'col-sm-7'p>>",
          }),
          $("#table1").dataTable(),
          $("#table2").dataTable({ pageLength: 6, dom: "<'row be-datatable-body'<'col-sm-12'tr>><'row be-datatable-footer'<'col-sm-5'i><'col-sm-7'p>>" }),
          $("#table3").dataTable({
          ...
          $("#table4").dataTable({ responsive: !0 }),
          $("#table5").dataTable({ responsive: { details: { display: $.fn.dataTable.Responsive.display.childRowImmediate, type: "" } } }),
          $("#table6").dataTable({
            responsive: {
              details: {
      ...
      (App.uiNotifications = function () {
        $("#not-basic").click(function () {
          ...
          $("#not-text").click(function () {
            return (
              $.gritter.add({ title: "Just Text", text: "This is a simple Gritter Notification. Etiam efficitur efficitur nisl eu dictum, nullam non orci elementum.", class_name: "clean", time: "" }),
              !1
            );
          }),
          $("#not-tr").click(function () {
            return (
              ...
              $.gritter.add({ title: "Top Right", text: "This is a simple Gritter Notification. Etiam efficitur efficitur nisl eu dictum, nullam non orci elementum", class_name: "clean" }),
              !1
            );
          }),
          $("#not-tl").click(function () {
            return (
              ...
              $.gritter.add({ title: "Top Left", text: "This is a simple Gritter Notification. Etiam efficitur efficitur nisl eu dictum, nullam non orci elementum", class_name: "clean" }),
              !1
            );
          }),
          $("#not-bl").click(function () {
            return (
              ...
              $.gritter.add({ title: "Bottom Left", text: "This is a simple Gritter Notification. Etiam efficitur efficitur nisl eu dictum, nullam non orci elementum", class_name: "clean" }),
              !1
            );
          }),
          $("#not-br").click(function () {
            return (
              ...
              $.gritter.add({ title: "Bottom Right", text: "This is a simple Gritter Notification. Etiam efficitur efficitur nisl eu dictum, nullam non orci elementum", class_name: "clean" }),
              !1
            );
          }),
          ...
          $("#not-primary").click(function () {
            $.gritter.add({ title: "Primary", text: "This is a simple Gritter Notification.", class_name: "color primary" });
          }),
          ...
          $("#not-warning").click(function () {
            $.gritter.add({ title: "Warning", text: "This is a simple Gritter Notification.", class_name: "color warning" });
          }),
          ...
          $("#not-dark").click(function () {
            $.gritter.add({ title: "Dark Color", text: "This is a simple Gritter Notification.", class_name: "color dark" });
          });
      }),
      App
    );
  ...
  (App = (function () {
    ...
    return (
      (App.uiSweetalert2 = function () {
        (Swal = Swal.mixin({ confirmButtonClass: "btn btn-primary", cancelButtonClass: "btn btn-secondary", buttonsStyling: !1 })),
          $("#swal-basic").click(function () {
            return Swal.fire({ text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce ultrices euismod lobortis.", confirmButtonText: "Proceed", showCloseButton: !0 }), !1;
          }),
          ...
          $("#swal-long").click(function () {
            return Swal.fire({ imageUrl: "https://placeholder.pics/svg/300x1500", imageHeight: 1500, imageAlt: "A tall image", confirmButtonText: "Proceed", showCloseButton: !0 }), !1;
          }),
          $("#swal-tr").click(function () {
            return Swal.fire({ position: "top-end", type: "success", title: "Sweetalert example", showConfirmButton: !1, timer: 1500, customClass: "content-header-center" }), !1;
          }),
          $("#swal-tl").click(function () {
            return Swal.fire({ position: "top-start", type: "success", title: "Sweetalert example", showConfirmButton: !1, timer: 1500, customClass: "content-header-center" }), !1;
          }),
          $("#swal-bl").click(function () {
            return Swal.fire({ position: "bottom-start", type: "success", title: "Sweetalert example", showConfirmButton: !1, timer: 1500, customClass: "content-header-center" }), !1;
          }),
          $("#swal-br").click(function () {
            return Swal.fire({ position: "bottom-end", type: "success", title: "Sweetalert example", showConfirmButton: !1, timer: 1500, customClass: "content-header-center" }), !1;
          }),
          ...
          $("#swal-queue").click(function () {
            return (
              Swal.mixin({
                ...
                .then(function (e) {
                  e.value && Swal.fire({ title: "All done!", html: "Your answers: <pre><code>" + JSON.stringify(e.value) + "</code></pre>", confirmButtonText: "Lovely!" });
                }),
              !1
            );
          }),
          ...
          $("#swal-file").click(function () {
            return Swal.fire({ title: "Select image", confirmButtonText: "Proceed", input: "file", inputAttributes: { accept: "image/*", "aria-label": "Upload your profile picture" } }), !1;
          });
      }),
      App
    );
