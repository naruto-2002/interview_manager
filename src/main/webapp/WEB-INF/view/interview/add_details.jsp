                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-left mr-4 star"
                                                       for="title">Schedule title</label>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-left mr-4 star"
                                                       for="candidate">Candidate name</label>
                                                <div class="col-12 col-sm-8 col-lg-8 text-sm-left">
                                                    <form:input type="text" class="d-none" id="title"
                                                                path="candidate.id" value="${candidate.id}"/>
                                                    <input class="form-control" id="candidate" type="text"
                                                           readonly="readonly" value="${candidate.name}"/>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-left mr-4 star">Schedule
                                                    Time</label>
                                                <div class="col-12 col-sm-8 col-lg-8">
                                                    <div class="input-group date datetimepicker" data-min-view="2"
                                                        ...
                                                        <div class="input-group-append">
                                                            <button class="btn btn-primary"><i
                                                                    class="icon-th mdi mdi-calendar"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class=" form-group row d-flex justify-content-center">
                                                <label class="col-form-label text-sm-right mr-2"
                                                       for="startTime">From:</label>
                                                <form:input class="col-2 form-control input-spacing mr-4" id="startTime"
                                                            path="startTime" type="text" placeholder="hh:mm"/>
                                                <label class="col-form-label text-sm-right mr-2"
                                                       for="endTime">To:</label>
                                                <form:input class="col-2 form-control mr-6" id="endTime" path="endTime"
                                                            type="text" placeholder="hh:mm"/>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-left mr-4 "
                                ...
                                <div class="bs-grid-block">
                                    <div class="card">
                                        <div class="card-body">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-8">
                                                    <div class="table-container">
                                                        <table class="table table-striped table-borderless">
                                                            <tr>
                                                                <td>
                                                                    <form:select id="searchable" multiple="multiple"
                                                                                 path="selectedInterviewerIds">
                                                                        <c:forEach var="interviewer"
                                                                                   items="${interviewers}">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-left mr-4 star"
                                                       for="recruiter">Recruiter owner</label>
                                                <div class="col-12 col-sm-8 col-lg-8 text-sm-left">
                                                    <form:input type="text" class="d-none" id="title"
                                                                path="recruiter.userId"
                                                                value="${candidate.user.userId}"/>
                                                    <input class="form-control" id="recruiter" type="text"
                                                           readonly="readonly" value="${candidate.user.fullName}"/>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-left mr-4"
                                            ...
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-left mr-4"
                                                       for="meetingId">Meeting ID</label>
                                                <div class="col-12 col-sm-8 col-lg-8">
                                                    <form:input class="form-control" id="meetingId" path="meetingId"
                                                                type="text" placeholder="Type a meeting id..."/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex justify-content-center align-items-center card-body">
                                            <div class="">
                                                <a href="/interview/add_candidate">
                                                    <button type="button"
                                                            class="ml-6 btn btn-space btn-secondary btn-width active">
                                                        Back
                                                    </button>
                                                </a>
                                                <button type="submit"
                                                        class="ml-6 btn btn-space btn-secondary btn-width active">Submit
                                                </button>
