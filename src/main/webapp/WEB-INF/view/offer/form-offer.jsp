          ...
          <form action="" class="row">
            <div class="col-lg-6">
              <div class="form-group row">
                <label class="col-2 text-sm-left text-offer">Default</label>
                <div class="col-lg-10">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-border-color card-border-color-primary">
              <div class="card-header card-header-divider">Advanced Controls<span class="card-subtitle">Select2 &
                  Bootstrap slider plugins</span></div>
              <div class="card-body">
                <form action="#">
                  <div class="form-group row">
