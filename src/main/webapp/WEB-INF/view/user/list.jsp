    ...
    <div class="main-content container-fluid">
        ...
        <div class="form-group row p-4">
            <div class="col-12 col-sm-5 col-lg-4">
                <form action="/user/search" method="get" class="input-group input-search">
        ...
        <button class="btn btn-secondary" type="submit"><i class="icon mdi mdi-search"></i></button>
            ...
            <div class="col-12 col-sm-2 col-lg-5 d-flex justify-content-end">
                <a href="/user/create" class="btn d-flex justify-content-center align-items-center" style="border-radius: 50%; border: 1px #000 solid;width: 40px; height: 40px">
                        ...
                        <div class="row be-datatable-body">
                            <div class="col-sm-12">
                                <table class="table table-striped table-hover table-fw-widget dataTable no-footer"
                                    ...
                                    <thead>
                                    <tr role="row">
                                        <th class="text-center" tabindex="0" aria-controls="table2" rowspan="1"
                                    ...
                                    <c:forEach items="${userPage.content}" var="user">
                                        <tr class="gradeA odd" role="row">
                                            ...
                                            <td class="text-center">
                                                <a href="/user/detail/${user.userId}" class="btn btn-info">Detail</a>
                                                <a href="/user/update/${user.userId}" class="btn btn-danger">Update</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            <li class="page-item  ${page <= 0 ? 'disabled' : ''}">
                                                <a class="page-link" href="/user?page=${page-1}" aria-label="Previous">
                                                    <span aria-hidden="true">&laquo;</span>
                                                </a>
                                            </li>
                                            <li class="page-item"><a class="page-link" href="/user?page=${page}">${page + 1}</a></li>
                                            <li class="page-item"><a class="page-link" href="/user?page=${page + 1}">${page + 2}</a></li>
                                            <li class="page-item  ${page >= pageSize - 1 ? 'disabled' : ''}">
                                                <a class="page-link" href="/user?page=${page + 1}" aria-label="Next">
